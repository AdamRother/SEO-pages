...
export const industries: IndustryPage[] = [
  {
    ...
    faqs: [
      ...
      { question: 'Can my entire team access client workspaces?', answer: 'Yes. All account users can access workspaces assigned to them. Workspace isolation is between clients, not between team members within your account.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'How does this handle multi-channel growth strategies?', answer: 'All channel-specific frameworks, performance data, and optimization playbooks can be organized within client workspaces. Intelligence applies the relevant channel frameworks to each client\'s specific context and performance history.' },
      { question: 'Is this useful for growth analytics work?', answer: 'Yes. Upload analytics exports, funnel data, and conversion reports to client workspaces. Intelligence analyzes the data against your growth frameworks to generate insight and recommendations specific to each client\'s situation.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'Is this useful for media planning as well as optimization?', answer: 'Yes. Upload media plans, audience segment definitions, and channel allocation frameworks to client workspaces. Intelligence applies your media planning methodology to each client\'s specific budget and objectives.' },
    ],
  },
  {
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'Can I upload website audits and SEO analysis to client workspaces?', answer: 'Yes. Technical audits, content analysis, SEO reports, and analytics exports can all be uploaded to the relevant client workspace. Intelligence references this analysis when generating recommendations.' },
      { question: 'Is this useful for creative agencies as well as performance-focused agencies?', answer: 'Yes. Creative briefs, brand guidelines, campaign history, and client feedback can all be stored in isolated client workspaces. Account teams maintain deep creative context for each brand without manual review.' },
  ...
  },
  {
    ...
    metaDescription: 'Independent consultants serve multiple clients with limited time and no team. Client Intelligence gives freelancers the per-client memory, framework encoding, and delivery leverage they need to scale.',
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'Can I use Client Intelligence for ABM campaign management?', answer: 'Yes. Upload target account lists, buying committee maps, and engagement history to client workspaces. Intelligence can inform account prioritization and message sequencing based on client-specific context.' },
      { question: 'How does this integrate with demand gen tools like 6sense or Bombora?', answer: 'Export intent data and engagement reports from these tools and upload to client workspaces. Intelligence analyzes the data within each client\'s isolated context  -  no native integration currently, but the document workflow is highly effective.' },
  ...
  },
  {
    ...
    scenarios: [
      { title: 'The Offer Context Confusion', story: 'A funnel agency built funnels for eight clients with different offers. Working across multiple clients in a shared AI environment caused copy angles and offer positioning to bleed between accounts.', result: 'With isolated client workspaces, each client\'s offer specifics, brand voice, avatar research, and funnel history are completely separate. Cross-client copy mixing became impossible.' },
    ...
    faqs: [
      { question: 'How do I store funnel assets and copy in client workspaces?', answer: 'Upload copy documents, funnel maps, split test results, and analytics exports to the client workspace. Intelligence references these assets when generating new copy angles and funnel recommendations for that client.' },
      ...
      { question: 'Can I manage funnel build projects within client workspaces?', answer: 'Yes. The workflow and project layer within each workspace handles task tracking, milestone management, and build phase documentation  -  keeping the entire funnel build project inside the client\'s isolated context.' },
    ],
  },
  {
    ...
    faqs: [
      { question: 'How do I work with site-specific data in client workspaces?', answer: 'Export analytics, Search Console data, and crawl reports and upload to the client workspace. Intelligence analyzes the data against your SEO frameworks within that client\'s isolated context.' },
      { question: 'Can I build SEO content strategies within client workspaces?', answer: 'Yes. Keyword clusters, content gap analyses, and editorial calendars can all be developed and stored within client workspaces  -  grounded in the client\'s specific keyword opportunity and competitive context.' },
  ...
  },
  {
    ...
    scenarios: [
      { title: 'The Voice and Context Depth Problem', story: 'A content strategy consultant served 10 clients across different industries. Maintaining each client\'s brand voice, audience context, and content history while producing genuinely differentiated strategies was becoming impossible.', result: 'Per-client workspaces holding brand guidelines, audience research, content audit findings, and engagement history let Intelligence generate recommendations that feel specific to each client  -  not generic content strategy advice.' },
    ...
    faqs: [
      { question: 'How do I store brand guidelines and voice documentation in client workspaces?', answer: 'Upload brand guideline documents, voice and tone guides, example content pieces, and style guides directly to the client workspace. Intelligence references these when generating strategic recommendations and content direction.' },
      { question: 'Can I use Client Intelligence for content performance analysis?', answer: 'Yes. Upload analytics exports and content performance reports to client workspaces. Intelligence analyzes performance against the client\'s strategic objectives and your content framework within their isolated context.' },
